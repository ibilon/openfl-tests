...
@:realPath("lime.graphics.GLRenderContext") @:native("WebGLRenderingContext") extern class GLRenderContext {
	...
	function attachShader(program : lime.graphics.opengl.GLProgram, shader : lime.graphics.opengl.GLShader) : Void;
	function bindAttribLocation(program : lime.graphics.opengl.GLProgram, index : Int, name : String) : Void;
	function bindBuffer(target : Int, buffer : lime.graphics.opengl.GLBuffer) : Void;
	function bindFramebuffer(target : Int, framebuffer : lime.graphics.opengl.GLFramebuffer) : Void;
	function bindRenderbuffer(target : Int, renderbuffer : lime.graphics.opengl.GLRenderbuffer) : Void;
	function bindTexture(target : Int, texture : lime.graphics.opengl.GLTexture) : Void;
	...
	function bufferData(target : Int, data:lime.utils.ArrayBufferView, usage : Int) : Void;
	...
	function compileShader(shader : lime.graphics.opengl.GLShader) : Void;
	...
	function createBuffer() : lime.graphics.opengl.GLBuffer;
	function createFramebuffer() : lime.graphics.opengl.GLFramebuffer;
	function createProgram() : lime.graphics.opengl.GLProgram;
	function createRenderbuffer() : lime.graphics.opengl.GLRenderbuffer;
	function createShader(type : Int) : lime.graphics.opengl.GLShader;
	function createTexture() : lime.graphics.opengl.GLTexture;
	function cullFace(mode : Int) : Void;
	function deleteBuffer(buffer : lime.graphics.opengl.GLBuffer) : Void;
	function deleteFramebuffer(framebuffer : lime.graphics.opengl.GLFramebuffer) : Void;
	function deleteProgram(program : lime.graphics.opengl.GLProgram) : Void;
	function deleteRenderbuffer(renderbuffer : lime.graphics.opengl.GLRenderbuffer) : Void;
	function deleteShader(shader : lime.graphics.opengl.GLShader) : Void;
	function deleteTexture(texture : lime.graphics.opengl.GLTexture) : Void;
	function depthFunc(func : Int) : Void;
	function depthMask(flag : Bool) : Void;
	function depthRange(zNear : Float, zFar : Float) : Void;
	function detachShader(program : lime.graphics.opengl.GLProgram, shader : lime.graphics.opengl.GLShader) : Void;
	...
	function flush() : Void;
	function framebufferRenderbuffer(target : Int, attachment : Int, renderbuffertarget : Int, renderbuffer : lime.graphics.opengl.GLRenderbuffer) : Void;
	function framebufferTexture2D(target : Int, attachment : Int, textarget : Int, texture : lime.graphics.opengl.GLTexture, level : Int) : Void;
	function frontFace(mode : Int) : Void;
	function generateMipmap(target : Int) : Void;
	function getActiveAttrib(program : lime.graphics.opengl.GLProgram, index : Int) : lime.graphics.opengl.GLActiveInfo;
	function getActiveUniform(program : lime.graphics.opengl.GLProgram, index : Int) : lime.graphics.opengl.GLActiveInfo;
	function getAttachedShaders(program : lime.graphics.opengl.GLProgram) : Array<lime.graphics.opengl.GLShader>;
	function getAttribLocation(program : lime.graphics.opengl.GLProgram, name : String) : Int;
	function getBufferParameter(target : Int, pname : Int) : Dynamic;
	function getContextAttributes() : lime.graphics.opengl.GLContextAttributes;
	...
	function getProgramInfoLog(program : lime.graphics.opengl.GLProgram) : String;
	function getProgramParameter(program : lime.graphics.opengl.GLProgram, pname : Int) : Dynamic;
	function getRenderbufferParameter(target : Int, pname : Int) : Dynamic;
	function getShaderInfoLog(shader : lime.graphics.opengl.GLShader) : String;
	function getShaderParameter(shader : lime.graphics.opengl.GLShader, pname : Int) : Dynamic;
	function getShaderPrecisionFormat(shadertype : Int, precisiontype : Int) : lime.graphics.opengl.GLShaderPrecisionFormat;
	function getShaderSource(shader : lime.graphics.opengl.GLShader) : String;
	function getSupportedExtensions() : Array<String>;
	function getTexParameter(target : Int, pname : Int) : Dynamic;
	function getUniform(program : lime.graphics.opengl.GLProgram, location : lime.graphics.opengl.GLUniformLocation) : Dynamic;
	function getUniformLocation(program : lime.graphics.opengl.GLProgram, name : String) : lime.graphics.opengl.GLUniformLocation;
	...
	function isBuffer(buffer : lime.graphics.opengl.GLBuffer) : Bool;
	function isContextLost() : Bool;
	function isEnabled(cap : Int) : Bool;
	function isFramebuffer(framebuffer : lime.graphics.opengl.GLFramebuffer) : Bool;
	function isProgram(program : lime.graphics.opengl.GLProgram) : Bool;
	function isRenderbuffer(renderbuffer : lime.graphics.opengl.GLRenderbuffer) : Bool;
	function isShader(shader : lime.graphics.opengl.GLShader) : Bool;
	function isTexture(texture : lime.graphics.opengl.GLTexture) : Bool;
	function lineWidth(width : Float) : Void;
	function linkProgram(program : lime.graphics.opengl.GLProgram) : Void;
	...
	function shaderSource(shader : lime.graphics.opengl.GLShader, string : String) : Void;
	...
	function uniform1f(location : lime.graphics.opengl.GLUniformLocation, x : Float) : Void;
	function uniform1fv(location : lime.graphics.opengl.GLUniformLocation, v : lime.utils.Float32Array) : Void;
	function uniform1i(location : lime.graphics.opengl.GLUniformLocation, x : Int) : Void;
	function uniform1iv(location : lime.graphics.opengl.GLUniformLocation, v : lime.utils.Int32Array) : Void;
	function uniform2f(location : lime.graphics.opengl.GLUniformLocation, x : Float, y : Float) : Void;
	function uniform2fv(location : lime.graphics.opengl.GLUniformLocation, v : lime.utils.Float32Array) : Void;
	function uniform2i(location : lime.graphics.opengl.GLUniformLocation, x : Int, y : Int) : Void;
	function uniform2iv(location : lime.graphics.opengl.GLUniformLocation, v : lime.utils.Int32Array) : Void;
	function uniform3f(location : lime.graphics.opengl.GLUniformLocation, x : Float, y : Float, z : Float) : Void;
	function uniform3fv(location : lime.graphics.opengl.GLUniformLocation, v : lime.utils.Float32Array) : Void;
	function uniform3i(location : lime.graphics.opengl.GLUniformLocation, x : Int, y : Int, z : Int) : Void;
	function uniform3iv(location : lime.graphics.opengl.GLUniformLocation, v : lime.utils.Int32Array) : Void;
	function uniform4f(location : lime.graphics.opengl.GLUniformLocation, x : Float, y : Float, z : Float, w : Float) : Void;
	function uniform4fv(location : lime.graphics.opengl.GLUniformLocation, v : lime.utils.Float32Array) : Void;
	function uniform4i(location : lime.graphics.opengl.GLUniformLocation, x : Int, y : Int, z : Int, w : Int) : Void;
	function uniform4iv(location : lime.graphics.opengl.GLUniformLocation, v : lime.utils.Int32Array) : Void;
	function uniformMatrix2fv(location : lime.graphics.opengl.GLUniformLocation, transpose : Bool, array : lime.utils.Float32Array) : Void;
	function uniformMatrix3fv(location : lime.graphics.opengl.GLUniformLocation, transpose : Bool, array : lime.utils.Float32Array) : Void;
	function uniformMatrix4fv(location : lime.graphics.opengl.GLUniformLocation, transpose : Bool, array : lime.utils.Float32Array) : Void;
	function useProgram(program : lime.graphics.opengl.GLProgram) : Void;
	function validateProgram(program : lime.graphics.opengl.GLProgram) : Void;
