...
extern class Vector3D {
	...
	function nearEquals(toCompare : Vector3D, tolerance : Float, allFour : Null<Bool> = false) : Bool;
	...
	static var X_AXIS(get,null) : Vector3D;
	static var Y_AXIS(get,null) : Vector3D;
	static var Z_AXIS(get,null) : Vector3D;
