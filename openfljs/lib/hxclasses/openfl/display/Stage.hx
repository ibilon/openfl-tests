...
@:access(openfl.events.Event) @:access(openfl.ui.GameInput) @:access(openfl.ui.Keyboard) extern class Stage extends DisplayObjectContainer implements lime.app.IModule {
	...
	var stage3Ds(default,null) : openfl.Vector<Stage3D>;
	var stageFocusRect : Bool;
	var stageHeight(default,null) : Int;
	var stageWidth(default,null) : Int;
	function new(width : Int, height : Int, color : Null<Int> = 0) : Void;
